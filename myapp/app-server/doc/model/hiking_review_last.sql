...
-- 댓글좋아요
DROP TABLE IF EXISTS hms_comment_like;

-- 게시판유형
DROP TABLE IF EXISTS hms_board_category;

-- 게시판좋아요
DROP TABLE IF EXISTS hms_board_like;
...
ALTER TABLE hms_mt_news
  MODIFY COLUMN mt_news_id INTEGER NOT NULL AUTO_INCREMENT;
...
ALTER TABLE hms_course_information
  MODIFY COLUMN course_information_id INTEGER NOT NULL AUTO_INCREMENT;
...
ALTER TABLE hms_board_category
  MODIFY COLUMN board_category_id INTEGER NOT NULL AUTO_INCREMENT;
