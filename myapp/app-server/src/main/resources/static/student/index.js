    ...
    .then((result) => {
      ...
      if (student.photo) {
        document.querySelector(
          "#f-photo-origin"
        ).href = `https://kr.object.ncloudstorage.com/bitcamp-bucket08-member-photo/${student.photo}`;
        document.querySelector(
          "#f-photo"
        ).src = `http://phvukofkrphk16694951.cdn.ntruss.com/${student.photo}?type=f&w=80&h=80&faceopt=true&ttype=jpg`;
      } else {
